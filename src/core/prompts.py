...
### CRITICAL RULES
- **INCLUDE ALL URLs**: You MUST include EVERY URL from the provided scraped content. Skipping URLs is a FAILURE.
...
- If the scraped content has 10 pages, you MUST output 10 links in the llms.txt"""
...
--- SOURCE CONTENT (scraped URLs to include) ---
{source_content}
--- end ---

CRITICAL: You MUST verify that ALL URLs from the SOURCE CONTENT above are included in the llms.txt draft.
Count the URLs in source, count the links in llms.txt. They MUST match."""
